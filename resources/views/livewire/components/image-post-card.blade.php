    ...
    <div class="max-w-xs md:max-w-sm bg-white border border-gray-200 rounded-lg shadow">
        ...
        <div class="p-3">
            ...
            <div class="flex gap-1 justify-between">
                ...
                {{-- Comment Count --}}
                <div class="flex gap-1 items-center float-end font-normal text-gray-700 dark:text-gray-400">
            ...
            <div class="flex items-center justify-around gap-2">
                ...
                <div class="w-full h-12">
                    <button wire:click='photoLike'
                        class="flex items-center gap-1 w-full justify-center h-full hover:bg-gray-200 rounded-md">
