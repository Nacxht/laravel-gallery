<div>
    <form wire:submit.prevent='userRegister' class="mt-5 grid grid-cols-12 col-span-12 space-y-4 md:space-y-6 gap-2">
        @csrf
        ...
        <label for="dropzone-file"
            ...
            <div class="flex items-center justify-center p-[0.2rem]">
                ...
                @if ($user->avatar)
                    <div class="h-full">
                        <img class="w-full h-full rounded-full aspect-square" src="{{ $avatar->temporaryUrl() }}"
                            alt="user-avatar">
                    </div>
                @endif
                {{-- *** --}}
